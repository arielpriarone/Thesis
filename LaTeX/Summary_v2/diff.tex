...
%DIF DEL ..\Summary_v1\Summary_flat.tex   Wed Mar 13 16:04:07 2024
%DIF ADD Summary_flat.tex                 Wed Mar 13 16:04:04 2024
...
\DIFdel{containing the features to be evaluated by the MLA, }\DIFdelend \DIFaddbegin \DIFadd{. Every collection has a specific role in the framework. For example, the }\DIFaddend \emph{Quarantined, Healthy} and \emph{Faulty} \DIFdelbegin \DIFdel{containing }\DIFdelend \DIFaddbegin \DIFadd{collections contain }\DIFaddend the features that have been flagged as novelty, normal or faulty, respectively\DIFdelbegin \DIFdel{, and }\emph{\DIFdel{Models}} %DIFAUXCMD
\DIFdel{containing the UML models.
The collection }\emph{\DIFdel{Backup}} %DIFAUXCMD
...
Some \DIFdelbegin \DIFdel{tests }\DIFdelend \DIFaddbegin \DIFadd{laboratory tests on the Edge implementation }\DIFaddend have shown that the standardization of the features is not always enough to make the clusters in the \DIFdelbegin \DIFdel{data }\DIFdelend \DIFaddbegin \DIFadd{feature }\DIFaddend space meaningful. \DIFdelbegin \DIFdel{In this case}\DIFdelend \DIFaddbegin \DIFadd{When this happened}\DIFaddend , in the PC implementation, Isolation Forest and Local Outlier Factor Models, being not cluster-based, \DIFdelbegin \DIFdel{have been }\DIFdelend \DIFaddbegin \DIFadd{were }\DIFaddend tested and resulted as more effective. As future work, the deployment of these models \DIFdelbegin \DIFdel{on }\DIFdelend \DIFaddbegin \DIFadd{also in }\DIFaddend the Edge implementation would \DIFdelbegin \DIFdel{bring a significant improvement in }\DIFdelend \DIFaddbegin \DIFadd{improve }\DIFaddend the performance of the framework in some specific applications. 
\end{document}
