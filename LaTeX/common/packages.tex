...
\usepackage[nobottomtitles*]{titlesec} % to avoid section titles at the bottom of the page
\usepackage{pgf}
\usepackage{pgfplots}
...
\def \thesisFigFontsize {10}

% \usepackage[allfiguresdraft]{draftfigure} % to have a draft of the figures
% \setdf{content={DRAFT DOCUMENT\\DO NOT DISTRIBUTE\\images missing!!!}} % to have a draft of the figures