...
The task of detecting the novelty is often associated with the task of predicting the remaining useful life (\gls{rul}), before the fault becomes fatal for the component.
