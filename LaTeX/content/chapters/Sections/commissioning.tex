...
\begin{figure}
    ...
    \caption{Fitted curve for \gls{rul} prediction. The texttt{scipy} library fit fails to estimate the parameter $c$. The closed-form solution actually minimizes the error.}
