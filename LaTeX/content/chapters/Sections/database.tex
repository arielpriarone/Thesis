...
\begin{longtable}{lll}
  ...
  \multirow{2}{*}{sensor 2} & sampling frequency & float \\*
   & time-serie & list[float] \\
  $\dots$ & $\dots$ & $\dots$ \\*
  \multirow{2}{*}{sensor~$n$} & sampling fequency & float \\*
   & time-serie & list[float] \\
  \bottomrule
  \end{longtable}
...
\begin{longtable}{lll}
  \caption{Structure of the \quoted{unconsumed} collection \gls{json} configuration file.}\\ 
  \toprule
  \textbf{Field} & \textbf{Sub-Field} & \textbf{Type} \endfirsthead 
  \hline
  \texttt{\textunderscore}id & - & string \\
...
\begin{longtable}{lll}
  \caption{Structure of the \quoted{models} collection \gls{json} configuration file.}\\ 
  \toprule
  \textbf{Field} & \textbf{Sub-Field} & \textbf{Type} \endfirsthead 
  \hline
  \texttt{\textunderscore}id & - & string \\
