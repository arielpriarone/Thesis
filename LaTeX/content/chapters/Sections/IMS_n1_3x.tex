...
\begin{table}
    ...
    Just P2P & 2003-11-22 16:06 & 4774 \\
    \bottomrule
    \end{tabular}
\end{table}
...
As anticipated in the \autoref{ch:state_of_the_art}, about the State of the Art, the signal of the same bearing (Bearing 3x) of this same test has been used in \cite{Umberto}. In their research, the authors used a different approach, based on regression, and obtained the result reported here in \autoref{fig:umbertoresult}
