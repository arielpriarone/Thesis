...
\subsection{Rraining,  evaluating and predicting after \gls{nd} event}
...
Let's investigate what would have happened if the user declared the system healthy at 2003-11-23 00:0, in the previous scenario of  \quoted{Bearing 3 x} signal in the \gls{ims} dataset. The \gls{mla} suggests that the best number of cluster is still two, so is has been retrained with the new data. The result of the updated model is shown in \autoref{fig:NoveltyScore_01_retrained}
