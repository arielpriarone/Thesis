...
\maskk{I would like to share, as a real-life example, what I witnessed during the \gls{glo:commissioning} of a new power plant. I remember that the \gls{glo:commissioning} manager (that is a chemist) was able to detect if the demineralization unit was working properly or not by simply tasting the water it produced before the necessary instruments were installed.}
