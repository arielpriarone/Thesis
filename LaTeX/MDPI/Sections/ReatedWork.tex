...
A powerful approach to data streams classification is proposed in \cite{Masud2011}. It is not a one-class approach as it manages more than one \quoted{normal} class as well as the emerging of novel classes during the classification task. 
