...
class Plotter:
    ...
    def plot_Kmeans_error_init(self,ax: plt.Axes):
        ...
        self.__legend_lines.append(Line2D([0], [0], linestyle='-.', color='r', lw=4, alpha=1))
    ...
    def plot_Kmeans_error(self,ax: plt.Axes):
        ...
        ax.set_xticks(custom_tick_locator(15,xlabels))
...
if __name__=='__main__': 
    ...
    # plt.show()
    fig, ax = plt.subplots()
    PLTR = Plotter(r"C:\Users\ariel\Documents\Courses\Tesi\Code\config.yaml")
