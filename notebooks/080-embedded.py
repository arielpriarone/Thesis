...
print("Number of features: ", features_matrix.shape[1])
...
n_blobs = input("Enter desired number of clusters: ")
n_blobs = int(n_blobs)

kmeans=kmeans=KMeans(n_clusters=n_blobs, init='k-means++', max_iter=1000, n_init=10)
y_pred_train=kmeans.fit_predict(standardized_features_matrix)
