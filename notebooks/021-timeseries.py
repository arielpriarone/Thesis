...
ax[0].plot(snap.rawData["time"], snap.rawData["Bearing 3 x"], label = "healthy", color='k', linewidth=0.1)
snap.readImsFile(path=dirPath+fileNames[1], variables="Bearing 3 x")
ax[1].plot(snap.rawData["time"], snap.rawData["Bearing 3 x"], label = "healthy", color='k', linewidth=0.1)
